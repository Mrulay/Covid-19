...
a = open(r"data\latest_stats.csv", "w+")
b = open(r"data\date_wise_totals.csv", "w+")
c = open(r"data\state_date_wise.csv", "w+")
a.close()
b.close()
c.close()
...
f = csv.writer(open(r"data\latest_stats.csv", "a"))
g = csv.writer(open(r"data\date_wise_totals.csv", "a"))
h = csv.writer(open(r"data\state_date_wise.csv", "a"))
